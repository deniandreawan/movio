  ...
  return (
    ...
    >
      <ModalVideo
        ...
        videoId={
          isEmpty(movie) ? null : movie.videos.results[0] ? movie.videos.results[0].key : null
        }
      />
          ...
          {movie.id && (
            <div className="backdrop__container">
              <img
                ...
                src={
                  movie.backdrop_path ? `${tmdbBackdropPath + movie.backdrop_path}` : imgBackground
                }
              />
            </div>
          )}
                ...
                {movie.id ? (
                  <LazyLoad debounce={false} offsetVertical={500}>
                    <ImageLoader
                      ...
                      imgId={movie.id}
                      src={
                        movie.poster_path ? `${tmdbPosterPath + movie.poster_path}` : imgPlaceholder
                      }
                    />
                  </LazyLoad>
                ) : (
