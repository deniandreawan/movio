...
const Home = (props) => {
  ...
  useDocumentTitle();
  useEffect(() => {
    if (isEmpty(popularMovies) || isEmpty(topRatedMovies) || isEmpty(upcomingMovies)) {
  ...
  return (
    <>
      {popularMovies.results ? (
        <MoviesSlider movies={popularMovies.results || []} favorites={favorites} />
      ) : (
      ...
      <div className="container__wrapper">
        {upcomingMovies.results && (
          <>
            ...
            <MovieList favorites={favorites} movies={upcomingMovies.results.slice(0, 8)} />
        ...
        {popularMovies.results && (
          <>
            ...
            <MovieList favorites={favorites} movies={popularMovies.results.slice(0, 8)} />
            <div className="movie__view-all">
              <button
                className="button--primary m-auto"
                onClick={() => props.history.push("/popular")}
        ...
        {topRatedMovies.results && (
          <>
            ...
            <MovieList favorites={favorites} movies={topRatedMovies.results.slice(0, 8)} />
            <div className="movie__view-all">
              <button
                className="button--primary m-auto"
                onClick={() => props.history.push("/top_rated")}
